...
<details class="exp">
<summary><strong>LLM Evaluation Standard:</strong> 7-point binary pass/fail framework; quality 5.3 to 6.7/7 in a quarter; adopted company-wide.</summary>
<div class="exp-body">
<p>Quality was measured on a subjective 1 to 5 "naturalness" scale that every tester read differently, turning weekly quality reviews into opinion battles. I invented a 7-point, binary <strong>pass/fail</strong> framework (Accuracy, Relevance, Conciseness, Harmlessness, Coherence, Response Length, and View Correspondence) that removed the ambiguity entirely.</p>
...
<details class="exp">
<summary><strong>Bixby Chat:</strong> rebuilt on a 3-tier LLM architecture with 9-category intent routing; 2x utterances, ~50% DAU/MAU lift; 14 languages on Galaxy S25.</summary>
<div class="exp-body">
...
<details class="exp">
<summary><strong>Natural-Language Device Help (Device QnA):</strong> RAG over product manuals; Device Settings failures 40% to under 10%; 15,000+ tickets/day deflected.</summary>
<div class="exp-body">
